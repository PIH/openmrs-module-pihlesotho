package org.openmrs.module.pihlesotho.metadata.deploy.handler;
...
public class ProviderRoleDeployHandler extends AbstractObjectDeployHandler<ProviderRole> {
	...
	/**
	 * Removes the given object which may be implemented as a void, retire or purge depending on the
	 * object
	 * 
